  ...
  return (
    <div className='lg:flex space-y-4 '>
      <div className='flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end'>
        <img src="./assets/Blue-Shape.svg" alt="img1" className='-rotate-45 h-64 md:h-72  lg:h-[400px]'/>
        <img src="./assets/Pink-Shape.svg" alt="img2" className='absolute -rotate-[30deg] h-64 md:h-72 lg:h-[400px]'/>
        <img src="./assets/Purple-Shape.svg" alt="img3" className='absolute -rotate-[15deg] h-64 md:h-72 lg:h-[400px]'/>
